...
CREATE SEQUENCE IF NOT EXISTS risk_mapping_mapping_id_seq;
...
CREATE TABLE risk_mapping (
    mapping_id INTEGER DEFAULT nextval('risk_mapping_mapping_id_seq'::regclass) NOT NULL,
    path_id VARCHAR(255) NOT NULL,
    product_id VARCHAR(255) NOT NULL,
    factory_id VARCHAR(255) NOT NULL,
    supplier_id VARCHAR(255),
...
CREATE INDEX ix_public_inventory_category ON inventory(category);
...
CREATE INDEX ix_public_order_items_order_id ON order_items(order_id);

-- Logistics: Stores logistics/shipping information
CREATE TABLE logistics (
    id INTEGER DEFAULT nextval('logistics_id_seq'::regclass) NOT NULL,
...
CREATE INDEX ix_public_logistics_order_id ON logistics(order_id);
...
CREATE INDEX idx_menu_code ON menu(menu_code);
