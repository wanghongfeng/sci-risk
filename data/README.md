...
SCI（Supply Chain Intelligence）供应链风险系统用于管理海尔集团全球供应链风险数据，支持关税风险评估、供应商风险分析和生产风险监控。

**数据库:** Neon PostgreSQL
**项目ID:** holy-darkness-17426941
...
|----------|--------|------|------|------|------|
| 2026-04-04 17:00 | ✅ | - | - | - | 初始数据库结构设计与seed_data初始化 |
...
| 表名                                   | 说明     | 关键字段                                    |
| ------------------------------------ | ------ | --------------------------------------- |
| [factory\_master](#factory_master)   | 工厂主数据  | factory\_id, country, capacity          |
| [supplier\_master](#supplier_master) | 供应商主数据 | supplier\_id, tier, credit\_rating      |
| [product\_master](#product_master)   | 产品主数据  | product\_id, product\_type, base\_price |

### 供应链表

| 表名                           | 说明   | 关键字段                                        |
| ---------------------------- | ---- | ------------------------------------------- |
| [bom\_master](#bom_master)   | 物料清单 | bom\_id, key\_component\_id, quantity       |
| [supply\_path](#supply_path) | 供应路径 | path\_id, lead\_time, transportation\_mode  |
| [tariff\_rule](#tariff_rule) | 关税规则 | tariff\_id, current\_tariff, future\_tariff |

### 业务表

| 表名                             | 说明   | 关键字段                              |
| ------------------------------ | ---- | --------------------------------- |
| [risk\_mapping](#risk_mapping) | 风险映射 | overall\_risk\_level, risk\_score |
| [sales\_order](#sales_order)   | 销售订单 | order\_id, quantity, status       |
