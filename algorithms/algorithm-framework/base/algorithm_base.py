...
from .notification import NotificationContext, notification_service
...
class AlgorithmBase(ABC):
    ...
    def algo_type(self) -> str:
        """二级分类: simulation / classification / assessment / order_simulation / ..."""
        pass
    ...
    def execute(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        返回: 任意 JSON dict（算法结果，基类会补充 taskId/status/duration）
        """
        pass
    ...
    def run(self,
        ...
        if notification_context:
            ctx = NotificationContext.from_dict(notification_context)
            result["algorithmName"] = self.name
            notification_service.send(ctx, result, result["duration"])
